...
In \eqref{eq:optimalrobustcs:equalitycritical4}, $\lambda \in \mathbb{R}^n$ is known as the \mync{Lagrange multipliers}. Equation \eqref{eq:optimalrobustcs:equalitycritical4} contains $m$ equations, and it is a portion of \myabb{Karush–Kuhn–Tucker}{KKT} conditions which will be introduced in more details later.
