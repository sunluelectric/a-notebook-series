...
It is worth mentioning that GitHub Actions can be triggered not only by repository-related events, but also external events, schedules, etc. Commonly seen triggers include
\begin{itemize}
	\item Repository-related events, such as push, pull request, etc. (Most common.)
...
A full list of GitHub events that can trigger GitHub Actions is provided in \cite{git2025reference}.

\subsection{Workflow Configuration Files}
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{lX}
        ...
        \texttt{needs} & Dependencies of the job. \\
...
\begin{table}[!htb]
	...
	\begin{tabularx}{\textwidth}{lX}
        ...
        \texttt{uses} & Alternative to \texttt{run}. A reusable pre-stored piece of code to be executed. \\
