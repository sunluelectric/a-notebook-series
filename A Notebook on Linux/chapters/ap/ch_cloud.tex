...
\begin{itemize}
    ...
    \item \mync{IPv6}: next generation IP address that is more powerful than IPv4.
    
    IPv6 differs from IPv4 in many aspects. Almost all IPv6 addresses are public addresses (there are some addresses reserved for special purposes), and NAT is likely to be unnecessary unless for additional security layer. 
...
As of this writing, IPv4 is still the most widely adopted IP address form. That said, AWS VPC has very good support of IPv6. Almost everything introduced in the remainder of this section can be set up with both IPv4 and IPv6 addresses.
