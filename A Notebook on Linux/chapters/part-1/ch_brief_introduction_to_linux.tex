...
As casual Linux users, people do not want to understand and compile the Linux source code to use Linux. In response to this need, different Linux distributions have emerged. They often come with installation packages friendly to amateur users. They share the same Linux OS kernel, but differ from each other in the add-ons such as software management tools and default user interfaces.
...
Notice that although the source code of all the distributions above is publicly available as required by GPL (GPL requires that any modified GPL-licensed product shall also be made open-source with a GPL license, as long as the modification spreads in the community), some of the distributions may come with a ``subscription fee''. The subscription fee is not for the OS source code, but for the technical support, paid maintenance, and other add-on services that the developers of the distributions provide to the end users.
...
\myabb{Graphical user interface}{GUI} is optional and many Linux servers are deployed without a \myabb{Graphical User Interface}{GUI}. Nevertheless, many Linux distributions support graphical desktops for the convenience of end users. When installing these distributions, the user has the option to install graphical desktop environments along with the OS. 
...
Linux can be installed on both fixed and mobile hard drives. The installation of different distributions may differ and details can be found on their corresponding website such as \cite{ubuntu2025ubuntu,fedora2025fedora,rhel2025rhel}. Thanks to the graphical installation tools for the popular distributions, the installations can be done fairly easily.
