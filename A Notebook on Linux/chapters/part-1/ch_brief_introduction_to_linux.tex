...
Linux can be installed on both fixed and mobile hard drives. The installation of different distributions may differ and details can be found on their corresponding website such as \cite{rhel2025rhel,fedora2025fedora,ubuntu2025ubuntu}. Thanks to the graphical installation tools for the popular distributions, the installations can be done fairly easily.
