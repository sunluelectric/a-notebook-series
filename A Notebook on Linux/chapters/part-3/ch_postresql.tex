...
\begin{itemize}
	...
	\item Modularized features, i.e., light-weight base installation and scalable addons.
...
The installation of PostgreSQL depends on the OS. In the following, RHEL 9.4 is used as an example. Both installation and authentication to the database are introduced.

\subsection{Installation}

PostgreSQL supports multiple operating systems including Linux, macOS and Windows. The source code and very detailed documentations of PostgreSQL are available on its official websites. Due to the light weight of the base installation, PostgreSQL can be used conveniently in containers. The official docker image can be found on Docker Hub.
