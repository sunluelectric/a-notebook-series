...
This section introduces \mync{docker}. Notice that though being famous for docker container engine, docker as a company or community provides many revolutionary container related tools and services that go far beyond a container engine brand. Many tools and technologies of docker are used in container runtimes and container engines of other brands.
...
Nevertheless, due to the popularity of docker, its installation is introduced below. Ubuntu Linux distribution is used as the host machine. Firstly, remove existing docker engine and runtime as follows.
\begin{lstlisting}
