...
The majority of the contents in this notebook were tested on machines with one of the following operating systems installed: Red Hat Enterprise Linux 9, CentOS 9 or Ubuntu. 