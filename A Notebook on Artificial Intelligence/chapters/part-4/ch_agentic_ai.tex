...
Comparing with manually deployment, the OpenAI Agents SDK offers at least the following features.
...
\begin{itemize}
	...
	\item In most scenarios, MCP servers run on the same physical machine as the host program, and they communicate with their MCP clients using standard I/O. In rare cases, MCP servers run on different machines other than the host program, in which case they leverage on other communication protocols.
