...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Decide the path of the pipeline based on the outputs of each AI agent.
    \end{itemize}
    \item Sub-tasks solving:
    \begin{itemize}
      \item Receive and comprehend unstructured inputs.
      \item Connect to other resources such as databases, computational units and actuators.
      \item Generate structured outputs.
...
\subsection{CrewAI} \label{sec:crewai}
