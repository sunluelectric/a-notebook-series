...
An example is given in Fig XXX.
...
Locally weighted regression, on the other hand, is a \mync{non-parametric learning algorithm}. The amount of parameters to be traced grows during the training process.
