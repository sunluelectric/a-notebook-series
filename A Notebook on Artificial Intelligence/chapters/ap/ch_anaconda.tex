...
As far as this notebook concerns, almost all the codes are developed using Python. There are many environment and package managers for Python. Two popular ones, \verb|conda| and \verb|uv|, are introduced in this appendix chapter.
