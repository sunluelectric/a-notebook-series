...
\begin{table}[!htb]
	...
	\begin{tabular}{lccc}
		\hline
		Model                  & Proprietary / Open-Source\textsuperscript{1} & Chatbot\textsuperscript{2} & API\textsuperscript{3} \\
		\hline
		GPT (OpenAI)           & P & Y & Y \\
