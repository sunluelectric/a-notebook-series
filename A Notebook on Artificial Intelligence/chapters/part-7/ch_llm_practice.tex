...
Ollama and Langflow are introduced. Ollama allows fast deployment of an open-source LLM on a PC, while Langflow is a low-code tool that allows a developer to easily integrate their applications with both open-source and commercialized LLMs.
...
\subsection{OpenAI API Powered LLM}
...
\subsection{Open-Source Model Powered LLM}
...
There are a couple of ways to use these models. Examples are given below.
