...
This chapter introduces the development of ``transformer'', an AI framework initially proposed in 2017 in a paper ``Attention is All You Need'' \cite{vaswani2017attention}. It has magically revolutionized how we train AI for NLP. The ``encoder-decoder'' framework it uses has inspired the development of generative AI.
...
\subsection{A Brief Review of CNN and RNN}
