...
Artificial Intelligence (AI) used to be included as part of the control system notebook, as in early ages it was mostly used as a system identification tool in control systems.

With the advent of graphical processing units (GPU) in the $1990$th and the Industry 4.0 initiatives in $2000$th, deep learning network with massive training data became possible, which significantly boosted the performance of artificial neural network (ANN)-based AI systems. Not to mention that the introduction of Transformer architecture has led to the remarkable development of large language models (LLM) and agentic AI frameworks. By the time of this writing, they have deeply shaped the way we work. Nowadays, AI has been growing rapidly with so many successful demonstrations of use cases such as computer vision, natural language processing and even general intelligence.
...
\begin{itemize}
  \item Andrew Ng, CS229 Machine Learning, Stanford, 2018
