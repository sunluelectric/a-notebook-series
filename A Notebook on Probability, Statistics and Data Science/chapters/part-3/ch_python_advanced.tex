\chapter{Python (Part II: Python for Data Science)} \label{ch:tftorch}

This chapter introduces commonly used Python-supported ANN engines used in data science, including data processing using \myabb{artificial intelligence}{AI}. Notice that theories behind AI and machine learning are given in other AI relevant notebooks. This chapter only focuses on implementations. Commonly seen ANN use cases such as computer vision and widely adopted ANN libraries such as TensorFlow and PyTorch are introduced.

The training and deployment of \myabb{large language models}{LLM}, although often done using Python, is also given in other AI relevant notebooks but not here. This is because LLM technologies are developing rapidly and it is better to put their relevant contents in dedicated notebooks.
...
\myabb{Natural language processing}{NLP} is another important use case of ANN.

\subsection{ANN Libraries in Python}
