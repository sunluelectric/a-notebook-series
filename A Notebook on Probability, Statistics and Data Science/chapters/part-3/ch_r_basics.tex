...
\mync{R language} is a programming language for statistical computing and visualization. It is widely used among statisticians and data miners for developing statistical software and carrying out data analysis. R is free and can be downloaded from \cite{r} where more details about R can also be found.
...
Download R and RStudio from \cite{r} and \cite{rstudio}, and install them following the instructions. It is required to install R before RStudio.
