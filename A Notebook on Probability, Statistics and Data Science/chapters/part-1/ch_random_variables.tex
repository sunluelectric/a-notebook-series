...
\end{eqnarray}
Think of $X$ as an estimation of a parameter $\theta$. If the estimation is non-biased, $E(X)=\theta$, and the variance of the estimates (left) equals to the MSE of the estimate (right) with sample numbers approaching infinity.
