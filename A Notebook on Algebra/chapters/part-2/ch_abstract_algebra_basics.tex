...
\section{Scope of Abstract Algebra}

Linear algebra has been introduced in the earlier part of this notebook. Linear algebra as well as other classic algebraic algorithms solves specific problems using algebra theories, whereas abstract algebra studies these theories. While classic algebra performs calculations on numbers, vector and matrices, \mync{abstract algebra} studies the concepts, tools, derivations and logic we use in the calculation, and tries to explain why they work in the way they do. Abstract algebra also develops new concepts, tools and algorithms that we can use to solve more complicated algebraic problems.
...
As another example, consider the following expressions taught in elementary schools
\begin{eqnarray}
	a+b &=& b+a \nonumber \\
	ab &=& ba \nonumber
\end{eqnarray}
