...
\begin{eqnarray}
  \norm{y^1(x) - y^2(x)}_1 &=& \max_{a\leq x \leq b} |y^1(x)-y^2(x)| \nonumber \\ && + \max_{a\leq x \leq b} |y^{1\prime}(x)-y^{2\prime}(x)| \label{eq:functionspacenorm1}
\end{eqnarray} 
...
Let $J[y]$ be a functional defined on some normed linear space. Let
\begin{eqnarray}
